...
export function SocialLinks({
  ...
  const linkClass = clsx(
    ...
    variant === 'light'
      ? 'text-light-tan hover:bg-white/10 hover:text-cream'
      : 'text-leather hover:bg-light-tan/40 hover:text-primary',
  )

  return (
    <div className={clsx('flex items-center gap-1', className)} aria-label="Social media">
      <a
        href={FACEBOOK_URL}
        target="_blank"
