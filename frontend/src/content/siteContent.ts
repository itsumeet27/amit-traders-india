...
export const IMAGES = {
  ...
  leatherCutting: '/catalog/samples/cutting.avif',
  stitching: '/catalog/samples/stitching.avif',
  finishing: '/catalog/samples/finishing.avif',
  packaging: '/catalog/samples/packaging.avif',
