...
public class CompanyProfileService {
    ...
    public CompanyProfileResponse upsert(CompanyProfileRequest request) {
        ...
        profile.setStoryHeadline(request.storyHeadline());
        profile.setMissionHeadline(request.missionHeadline());
        profile.setMission(request.mission());
        profile.setMissionCommitmentsJson(request.missionCommitmentsJson());
        profile.setMissionClosing(request.missionClosing());
        profile.setVisionHeadline(request.visionHeadline());
        profile.setVision(request.vision());
        profile.setAboutHeroTitle(request.aboutHeroTitle());
        profile.setAboutHeroSubtitle(request.aboutHeroSubtitle());
        profile.setAboutValuesJson(request.aboutValuesJson());
        profile.setAboutPromiseHeadline(request.aboutPromiseHeadline());
        profile.setAboutPromiseBody(request.aboutPromiseBody());
        profile.setAboutPromiseClosing(request.aboutPromiseClosing());
